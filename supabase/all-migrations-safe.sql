-- MeowMeow Live Chat Platform — Safe Combined Migrations (Idempotent)
...
CREATE TABLE IF NOT EXISTS public.shift_earnings (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_shift_earnings_shift_id ON public.shift_earnings(shift_id);
CREATE INDEX IF NOT EXISTS idx_shift_earnings_user_id ON public.shift_earnings(user_id);
...
-- Create indexes
CREATE INDEX IF NOT EXISTS idx_scheduled_shifts_user_date ON public.scheduled_shifts(user_id, scheduled_date);
CREATE INDEX IF NOT EXISTS idx_attendance_user_date ON public.attendance(user_id, attendance_date);
CREATE INDEX IF NOT EXISTS idx_absence_records_user_date ON public.absence_records(user_id, absence_date);
...
CREATE TABLE IF NOT EXISTS public.language_groups (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  name TEXT NOT NULL,
  description TEXT,
...
CREATE INDEX IF NOT EXISTS idx_backup_logs_started_at ON public.backup_logs(started_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_legal_documents_version ON public.legal_documents(name, version);
...
CREATE TABLE IF NOT EXISTS public.chat_pricing (
  id uuid NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS public.women_earnings (
  id uuid NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  user_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.women_availability (
  id uuid NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  user_id uuid NOT NULL UNIQUE,
...
CREATE INDEX IF NOT EXISTS idx_active_chat_sessions_man_user ON public.active_chat_sessions(man_user_id);
CREATE INDEX IF NOT EXISTS idx_active_chat_sessions_woman_user ON public.active_chat_sessions(woman_user_id);
CREATE INDEX IF NOT EXISTS idx_active_chat_sessions_status ON public.active_chat_sessions(status);
CREATE INDEX IF NOT EXISTS idx_women_earnings_user ON public.women_earnings(user_id);
CREATE INDEX IF NOT EXISTS idx_women_availability_available ON public.women_availability(is_available, current_chat_count);
...
CREATE TABLE IF NOT EXISTS public.women_shift_assignments (
  id uuid NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  user_id uuid NOT NULL UNIQUE,
...
-- Create indexes
CREATE INDEX IF NOT EXISTS idx_women_shift_assignments_user ON public.women_shift_assignments(user_id);
CREATE INDEX IF NOT EXISTS idx_women_shift_assignments_shift ON public.women_shift_assignments(shift_template_id);
CREATE INDEX IF NOT EXISTS idx_women_shift_assignments_language ON public.women_shift_assignments(language_group_id);
...
CREATE TABLE IF NOT EXISTS public.chat_wait_queue (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  user_id UUID NOT NULL,
...
-- Create index for faster queries
CREATE INDEX IF NOT EXISTS idx_chat_wait_queue_status ON public.chat_wait_queue(status);
CREATE INDEX IF NOT EXISTS idx_chat_wait_queue_language ON public.chat_wait_queue(preferred_language);
CREATE INDEX IF NOT EXISTS idx_chat_wait_queue_joined_at ON public.chat_wait_queue(joined_at);
...
CREATE TABLE IF NOT EXISTS public.sample_men (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  name text NOT NULL,
  age integer NOT NULL DEFAULT 25,
  country text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.sample_women (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  name text NOT NULL,
  age integer NOT NULL DEFAULT 25,
  country text NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_sample_men_language ON public.sample_men(language);
CREATE INDEX IF NOT EXISTS idx_sample_men_active ON public.sample_men(is_active);
CREATE INDEX IF NOT EXISTS idx_sample_women_language ON public.sample_women(language);
CREATE INDEX IF NOT EXISTS idx_sample_women_active ON public.sample_women(is_active);
...
CREATE TABLE IF NOT EXISTS public.language_limits (
  id uuid NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS public.community_shift_schedules (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  language_code TEXT NOT NULL,
  user_id UUID NOT NULL,
...
-- Create indexes for performance
CREATE INDEX IF NOT EXISTS idx_community_disputes_language ON public.community_disputes(language_code);
CREATE INDEX IF NOT EXISTS idx_community_disputes_status ON public.community_disputes(status);
CREATE INDEX IF NOT EXISTS idx_community_shift_schedules_language ON public.community_shift_schedules(language_code);
CREATE INDEX IF NOT EXISTS idx_community_shift_schedules_date ON public.community_shift_schedules(shift_date);
CREATE INDEX IF NOT EXISTS idx_community_announcements_language ON public.community_announcements(language_code);
...
CREATE TABLE IF NOT EXISTS public.election_officers (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  language_code TEXT NOT NULL,
  user_id UUID NOT NULL,
...
-- Create indexes for performance
CREATE INDEX IF NOT EXISTS idx_elections_language_year ON public.community_elections(language_code, election_year);
CREATE INDEX IF NOT EXISTS idx_elections_status ON public.community_elections(status);
CREATE INDEX IF NOT EXISTS idx_candidates_election ON public.election_candidates(election_id);
CREATE INDEX IF NOT EXISTS idx_votes_election ON public.election_votes(election_id);
CREATE INDEX IF NOT EXISTS idx_votes_candidate ON public.election_votes(candidate_id);
CREATE INDEX IF NOT EXISTS idx_voter_registry_election ON public.voter_registry(election_id);
CREATE INDEX IF NOT EXISTS idx_leaders_language ON public.community_leaders(language_code);
CREATE INDEX IF NOT EXISTS idx_officers_language ON public.election_officers(language_code);
...
CREATE TABLE IF NOT EXISTS public.admin_revenue_transactions (
    id uuid NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_admin_revenue_type ON public.admin_revenue_transactions(transaction_type);
CREATE INDEX IF NOT EXISTS idx_admin_revenue_created ON public.admin_revenue_transactions(created_at);
CREATE INDEX IF NOT EXISTS idx_admin_revenue_man ON public.admin_revenue_transactions(man_user_id);
...
CREATE TABLE IF NOT EXISTS public.translation_dictionaries (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_translation_source ON public.translation_dictionaries (source_language, source_text);
CREATE INDEX IF NOT EXISTS idx_translation_english ON public.translation_dictionaries (english_text);
CREATE INDEX IF NOT EXISTS idx_translation_target ON public.translation_dictionaries (target_language, english_text);
...
CREATE INDEX IF NOT EXISTS idx_common_phrases_key ON public.common_phrases (phrase_key);
CREATE INDEX IF NOT EXISTS idx_common_phrases_english ON public.common_phrases (english);
...
CREATE TABLE IF NOT EXISTS public.translation_idioms (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS public.translation_word_senses (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  word TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.translation_morphology_rules (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  language_code TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_translation_idioms_phrase ON public.translation_idioms(normalized_phrase);
CREATE INDEX IF NOT EXISTS idx_translation_grammar_rules_code ON public.translation_grammar_rules(language_code);
CREATE INDEX IF NOT EXISTS idx_translation_word_senses_word ON public.translation_word_senses(word);
CREATE INDEX IF NOT EXISTS idx_translation_morphology_rules_lang ON public.translation_morphology_rules(language_code);
...
CREATE TABLE IF NOT EXISTS public.women_kyc (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  user_id UUID NOT NULL UNIQUE,
...
CREATE INDEX IF NOT EXISTS idx_women_kyc_user_id ON public.women_kyc(user_id);
CREATE INDEX IF NOT EXISTS idx_women_kyc_status ON public.women_kyc(verification_status);
...
CREATE TABLE IF NOT EXISTS public.golden_badge_subscriptions (
  id uuid NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  user_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.women_chat_modes (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  user_id UUID NOT NULL UNIQUE,
...
-- Index for fast lookups
CREATE INDEX IF NOT EXISTS idx_women_chat_modes_user_id ON public.women_chat_modes(user_id);
CREATE INDEX IF NOT EXISTS idx_women_chat_modes_mode ON public.women_chat_modes(current_mode);
...
CREATE TABLE IF NOT EXISTS public.men_free_chat_allowance (
  id uuid NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  user_id uuid NOT NULL UNIQUE,
...
-- Index for fast lookups
CREATE INDEX IF NOT EXISTS idx_admin_user_messages_target ON public.admin_user_messages(target_group, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_admin_user_messages_user ON public.admin_user_messages(target_user_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_admin_user_messages_created ON public.admin_user_messages(created_at);
