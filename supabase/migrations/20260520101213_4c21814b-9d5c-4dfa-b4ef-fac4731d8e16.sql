-- Replace get_online_men_dashboard so wallet_balance is derived from canonical wallet_transactions
...
BEGIN
  ...
  -- Canonical balance from wallet_transactions (Single Source of Truth)
  LEFT JOIN LATERAL (
    SELECT COALESCE(SUM(wt.amount), 0)::numeric AS balance
