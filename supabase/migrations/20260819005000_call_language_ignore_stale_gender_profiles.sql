-- Stale male_profiles/female_profiles (old Telugu) was chosen before the
-- newest user_languages/Hindi primary, so 1:1 inserts failed even when the
-- dashboard showed the same language.
