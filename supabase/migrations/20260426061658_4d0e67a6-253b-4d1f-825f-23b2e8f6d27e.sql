-- New on-demand snapshot function: captures all women with balance > 0
-- at the moment of invocation, using all 10 spec fields from women_kyc
-- and the closing wallet balance as the payout amount.
