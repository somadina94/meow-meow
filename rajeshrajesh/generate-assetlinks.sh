...
#    https://www.meow-meow.co.in/.well-known/assetlinks.json
...
if [ -n "${KEYSTORE_PASSWORD:-}" ]; then
  KEYTOOL_PASS_ARGS=(-storepass "$KEYSTORE_PASSWORD")
fi
SHA256=$(keytool -list -v -keystore android.keystore -alias android "${KEYTOOL_PASS_ARGS[@]}" 2>/dev/null \
...
echo "   https://www.meow-meow.co.in/.well-known/assetlinks.json"
echo ""
...
echo "   curl https://www.meow-meow.co.in/.well-known/assetlinks.json"
echo ""
